...
export function Formacao() {
  return (
    <section id="formacao" className="px-8 md:h-[50vh]">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="relative border-l-4 border-cyan-400  border-solid pl-6 py-4">
          <div className="group mb-8 ml-6 border-2 rounded-4xl p-4  shadow-[0_0_35px_rgba(34,211,238,0.5)] hover:scale-110 duration-300">
